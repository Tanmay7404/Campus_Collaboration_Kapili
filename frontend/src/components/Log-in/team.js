...
import priyanshuPic from '../../assets/TeamImage/priyanshu.jpg';
import sushantPic from '../../assets/TeamImage/sushant.jpg';
import rishiPic from '../../assets/TeamImage/rishi.jpg';
import piyushPic from '../../assets/TeamImage/piyush.jpg';
...
const teamMembers = [
  { name: 'Tanmay Mittal', title: 'Full Stack', code: 1, description: 'I am a womenizer.', linkedin: 'https://www.linkedin.com/in/tanmay-mittal-b98b79261/?originalSubdomain=in', github: "https://github.com/Tanmay7404" },
  { name: 'Simon Lal Singh', title: 'Full Stack', code: 2, description: 'I love cubing and programming.', linkedin: 'https://www.linkedin.com/in/simon-lalremsiama-shangpliang-65130b287', github: "https://github.com/SimonShangpliang" },
  ...
  return (
    <>
      <div className="team-section">
        <div className="ff">
          <div style={{fontSize:'3rem'}}>Meet the Team</div>
        </div>
        <div className="team-grid">
          {teamMembers.map((member, index) => (
            <div key={index} className="team-member">
              <img src={profiles[member.code]} alt={member.name} />
              <h3>{member.name}</h3>
              <p>{member.title}</p>
              ...
              <div className="social-links">
                {/* {
                // member.linkedin && 
                //Uncomment above if you want to display only if link is provided
                (
