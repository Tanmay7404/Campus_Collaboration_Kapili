...
export default function CreateProjectPage({projects}) {
...
<div class="containerPP">
  ...
  <div class="contentPP" style={{overflow:"scroll"}}>
...
<Button className="box" variant="dark" style={{ height: 25, width: 25, borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center' ,marginLeft:10,margin:'0'}}>
      <h2 >+</h2>
    </Button>
</div>
<div className="space">
