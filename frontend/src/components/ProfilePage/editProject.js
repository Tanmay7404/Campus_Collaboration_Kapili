...
<div className="fillWidthDiv2">
    <h3 style={{color:"white"}} className="editProfile" ><b>Edit Project</b></h3>
</div>
...
<Button className="box" variant="dark" style={{ height: 25,margin:'0' ,width: 25, borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center' ,marginLeft:10}}>
      <h2 >+</h2>
    </Button>
</div>
<div className="space">
