...
const Navbar = (props) => {
  ...
  return (
    <div id="main">
      ...
      {showTag ? <div ref={tagRef}><Tag onTagClick = {toggleTagSelection} tagList={selectedTags} setSelectedSearch={setSelectedSearch} selectedSearch={selectedSearch}/></div> : null}
      <Outlet />
    </div>
  );
};
